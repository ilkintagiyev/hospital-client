                        ...
                        <AnimatePresence initial={false} custom={direction} mode="wait">
                            ...
                            >
                                ...
                                </p>
                                {
                                    user?.role === "doctor" ? (
                                        <button
                                            className="mt-4 inline-block bg-blue-600 hover:bg-blue-800 active:bg-blue-900 transition duration-300 text-white text-lg font-semibold py-3 px-8 rounded-xl shadow-lg hover:shadow-2xl"
                                        >
                                            Profilə bax
                                        </button>
                                    ) : (
                        ...
                        {doctors.length > 1 && (
                            <>
                                <button
                                    ...
                                    className="absolute left-4 top-1/2 -translate-y-1/2 bg-white hover:bg-gray-100 rounded-full p-3 shadow-lg transition-shadow duration-300 hover:shadow-2xl"
                                >
                                ...
                                <button
                                    ...
                                    className="absolute right-4 top-1/2 -translate-y-1/2 bg-white hover:bg-gray-100 rounded-full p-3 shadow-lg transition-shadow duration-300 hover:shadow-2xl"
                                >
